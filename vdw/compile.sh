...
mpif90 -g -Wall -fcheck=all -fcheck=bounds -g -fcheck=all -Wall -fPIC -O3 -lopenblas  soap_turbo_functions.f90 soap_turbo_compress.f90 soap_turbo_angular.f90 soap_turbo_radial.f90 soap_turbo.f90  test.f90  fortran_cuda_interfaces.o  cuda_wrappers.o -lopenblas  -lcudart   -lcublas 
